...
export default function CartPage() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-slate-50/50">
      {/* 1. Header Section */}
      <div className="bg-white border-b border-slate-100/80 sticky top-0 z-10 backdrop-blur-md bg-white/80">
        ...
        {isCartEmpty ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-white border border-slate-100 p-6 rounded-[2rem] shadow-sm relative overflow-hidden">
